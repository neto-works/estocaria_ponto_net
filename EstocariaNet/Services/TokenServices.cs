...
namespace EstocariaNet.Services
{
    public class TokenServices : ITokenServices
    {
        ...
        {
            var securiRamdomBytes = new byte[128];
            using var randomNumberGerator = RandomNumberGenerator.Create();
            randomNumberGerator.GetBytes(securiRamdomBytes);
            var refreshToken = Convert.ToBase64String(securiRamdomBytes);
